class Poker extends Phaser.GameObjects.Sprite {
    constructor(scene, x, y, texture, frame, ground, type) {
      ...
      this.sprite = scene.physics.add.sprite(x, y, 'stal').setOrigin(0, 0);
      ...
      scene.physics.add.collider(this.sprite, scene.runner.sprite, (sprite, runner) => {
        ...
        //this.scene.runner.sprite.body.collideWorldBounds = false;
      });
    ...
    update(){
        ...
        this.sprite.body.velocity.y = this.downSpeed;
